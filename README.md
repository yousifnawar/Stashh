...
[![CI](https://github.com/YOUR-USERNAME/stash/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR-USERNAME/stash/actions/workflows/ci.yml)
...
Grab the latest `.dmg` from [**Releases**](https://github.com/YOUR-USERNAME/stash/releases/latest),
